...
try{
    $pdo=new PDO("mysql:dbname=PHP中級課題;host=localhost;","root","root");
}catch(PDOException $e){
    die("<p>申し訳ございません。現在サーバーが混み合っており一時的にアクセスが出来ません。<br>しばらくしてから再度ログインして下さい。</p>
  ...
  <body>
    ...
    <main>
      <div class="mypage_box">
        <h2>会員情報</h2>
        <div class="aisatsu"><p>こんにちは！ <?php echo $_SESSION['name'];?>さん</p></div>
